 ...
 */
public class SystemBilling extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(SystemColor.scrollbar);
        ...
        consumerno.setText("0");
        jCheckBox2 = new javax.swing.JCheckBox();
        jCheckBox2.setBackground(SystemColor.controlHighlight);
        jCheckBox1 = new javax.swing.JCheckBox();
        jCheckBox1.setBackground(SystemColor.controlHighlight);
        jLabel1 = new javax.swing.JLabel();
        jLabel6 = new javax.swing.JLabel();
        connectload = new javax.swing.JTextField();
        ...
        jLabel13.setBackground(SystemColor.inactiveCaption);
        ...
        jLabel14.setForeground(new Color(51, 51, 0));
        ...
        billno.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        billno.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        billno.setText("0");
        ...
        jPanel2.add(billno);
        billno.setBounds(190, 290, 110, 30);

      areacode.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
       ...
       areacode.addActionListener(new java.awt.event.ActionListener() {
        ...
        jPanel2.add(areacode);
     areacode.setBounds(190, 80, 110, 30);

     metercode.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
     ...
     metercode.addActionListener(new java.awt.event.ActionListener() {
        ...
        jPanel2.add( metercode);
        metercode.setBounds(190, 140, 110, 30);
        ...
        jTextField9.setBounds(330, 221, 110, 30);
        ...
        jTextField10.setBounds(330, 281, 110, 30);
        ...
        consumerno.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        consumerno.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        consumerno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField1ActionPerformed(evt);
            }
        });
        jPanel2.add(consumerno);
        consumerno.setBounds(190, 30, 110, 30);

        jCheckBox2.setFont(new java.awt.Font("Calibri", 1, 14)); // NOI18N
        jCheckBox2.setText("CONNECTEDLOAD");
        ...
        connectload.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        connectload.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        connectload.setText("0");
        jPanel2.add(connectload);
        connectload.setBounds(190, 210, 60, 30);
        ...
        jLabel13.setBounds(160, 49, 180, 30);

        tax1.setEditable(false);
        tax1.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        tax1.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        tax1.setText("Rs 0.00");
        tax1.setPreferredSize(new java.awt.Dimension(65, 30));
        ...
        totalamount.setPreferredSize(new java.awt.Dimension(65, 30));
        totalamount.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextField13ActionPerformed(evt);
            }
        });
        jPanel7.add(totalamount);
        totalamount.setBounds(380, 90, 310, 30);

        subtotal1.setEditable(false);
        subtotal1.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        subtotal1.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        subtotal1.setText("Rs 0.00");
        subtotal1.setPreferredSize(new java.awt.Dimension(65, 30));
        jPanel7.add(subtotal1);
        subtotal1.setBounds(380, 10, 310, 30);
        ...
        jLabel14.setText("ELECTRICITY BILLING SYSTEM");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       {
           double M = Double.parseDouble( metercode.getText()) * 30;
           double C = Double.parseDouble(connectload.getText()) * 30;
           ...
           subtotal1.setText((String)sub);
           
           String ta = String.format("%.2f",tax);
           tax1.setText((String)ta);
           
           String a = String.format("%.2f",amount);
           totalamount.setText((String)a);
       }
       else
       {
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
       ...
       {
    	   metercode.setEditable(true);
    	   metercode.setText(" ");
    	   metercode.requestFocus();
       }
       else
       {
           metercode.setEditable(true);
    ...
    private void jCheckBox2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox2ActionPerformed
       ...
       {
    	   connectload.setEditable(true);
           connectload.setText(" ");
           connectload.requestFocus();
       }
       else
       {
    	   connectload.setEditable(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SystemBilling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SystemBilling().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField connectload;
...
public void insertDataIntoDB() throws Exception
{
	...
	Class.forName("com.mysql.jdbc.Driver");
 	...
 	String query1 = null;
		query1 = "insert into bill values('"+ consumerno.getText() + "','"+ areacode.getText()+"','"+  billno.getText() +"','"+ metercode.getText() +"','"+connectload.getText() +"','"+ totalamount.getText() +"')";
